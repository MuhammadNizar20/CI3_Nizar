...
<body>
   ...
   <div class="container">
       <div class="card card-body rounded position-absolute top-50 start-50 translate-middle" style="width: 18rem;">
        <form action="<?php echo base_url('index.php/daftar/action_tambah')?>" method="post">
    <div class="mb-3">
    ...
    <a href=" <?php echo base_url('index.php/daftar') ?> ">
    <div class="d-grid gap-2">
    <button class="btn btn-success">Data Siswa</button>
    </div>
    </a>
